...
?>
      <div class="row banner">
         <div class="banner-text">
            <h1 class="responsive-headline logo" id="style_name">I'm <?php echo isset($user) ? ucwords($user['firstname'].' '.$user['lastname']) : ""; ?>.</h1>
            <h3 style="color: #ffffff;"><?php echo stripslashes($_settings->info('welcome_message')) ?></h3>
      ...
      <div class="row skill">
        ...
        <div class="bars">
           ...
           <ul class="skills">
            ...
            <li><span class="bar-expand wordpress"></span><em>premiere pro</em></li>
